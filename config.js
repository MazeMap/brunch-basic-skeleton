        ...
        files: {
            javascripts: {
                ...
                joinTo: {
                    ...
                    'test/resources/javascripts/test.js': /^test[\\/](?!vendor)/,
                    'test/resources/javascripts/test-vendor.js': /^test[\\/](?=vendor)/
                },
                order: {
                    before: [''],
                    after: ['']
            ...
            stylesheets: {
                ...
                joinTo: {
                    'resources/stylesheets/app.css': /^(app|vendor\/styles)/,
                    'test/resources/stylesheets/test.css': /^test/
                },
                order: {
            ...
            templates: {
                ...
                joinTo: 'resources/javascripts/app.js'
            }
        },
        plugins: {
            jshint: {
